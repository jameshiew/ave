        ...
        match self.blocks.get(&(x, y, z)) {
            Some(block_type) => match block_type {
                ...
                &BlockType::Solid => Some(VertexBuffer::new(facade, &[
                    Vertex { position: [self.get_x(x) as f32 - BLOCK_SIZE, self.get_y(y) as f32 - BLOCK_SIZE, self.get_z(z) as f32 - BLOCK_SIZE], normal: [1.0, 0.0, 0.0]},
                    Vertex { position: [self.get_x(x) as f32 - BLOCK_SIZE, self.get_y(y) as f32 - BLOCK_SIZE, self.get_z(z) as f32 + BLOCK_SIZE], normal: [1.0, 0.0, 0.0]},
                    Vertex { position: [self.get_x(x) as f32 - BLOCK_SIZE, self.get_y(y) as f32 + BLOCK_SIZE, self.get_z(z) as f32 - BLOCK_SIZE], normal: [1.0, 0.0, 0.0]},
                    Vertex { position: [self.get_x(x) as f32 - BLOCK_SIZE, self.get_y(y) as f32 + BLOCK_SIZE, self.get_z(z) as f32 + BLOCK_SIZE], normal: [1.0, 0.0, 0.0]},
                    ...
                    Vertex { position: [self.get_x(x) as f32 - BLOCK_SIZE, self.get_y(y) as f32 + BLOCK_SIZE, self.get_z(z) as f32 - BLOCK_SIZE], normal: [0.0, -1.0, 0.0]},
                    Vertex { position: [self.get_x(x) as f32 - BLOCK_SIZE, self.get_y(y) as f32 + BLOCK_SIZE, self.get_z(z) as f32 + BLOCK_SIZE], normal: [0.0, -1.0, 0.0]},
                    Vertex { position: [self.get_x(x) as f32 + BLOCK_SIZE, self.get_y(y) as f32 + BLOCK_SIZE, self.get_z(z) as f32 - BLOCK_SIZE], normal: [0.0, -1.0, 0.0]},
                    Vertex { position: [self.get_x(x) as f32 + BLOCK_SIZE, self.get_y(y) as f32 + BLOCK_SIZE, self.get_z(z) as f32 + BLOCK_SIZE], normal: [0.0, -1.0, 0.0]},
                    ...
                    Vertex { position: [self.get_x(x) as f32 - BLOCK_SIZE, self.get_y(y) as f32 - BLOCK_SIZE, self.get_z(z) as f32 - BLOCK_SIZE], normal: [0.0, 0.0, 1.0]},
                    Vertex { position: [self.get_x(x) as f32 - BLOCK_SIZE, self.get_y(y) as f32 + BLOCK_SIZE, self.get_z(z) as f32 - BLOCK_SIZE], normal: [0.0, 0.0, 1.0]},
                    Vertex { position: [self.get_x(x) as f32 + BLOCK_SIZE, self.get_y(y) as f32 - BLOCK_SIZE, self.get_z(z) as f32 - BLOCK_SIZE], normal: [0.0, 0.0, 1.0]},
                    Vertex { position: [self.get_x(x) as f32 + BLOCK_SIZE, self.get_y(y) as f32 + BLOCK_SIZE, self.get_z(z) as f32 - BLOCK_SIZE], normal: [0.0, 0.0, 1.0]},
